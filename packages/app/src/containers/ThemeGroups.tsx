...
const SwatchesGroup = memo(() => {
  ...
  return (
    <ContainerGroup
      ...
      selectedGroup={state.selectedTheme.swatches.groupName}
    />
  );
});
...
const TextStylesGroup = memo(() => {
  ...
  return (
    <ContainerGroup
      ...
      selectedGroup={state.selectedTheme.textStyles.groupName}
    />
  );
});
...
const ThemeStylesGroup = memo(() => {
  ...
  return (
    <ContainerGroup
      ...
      selectedGroup={state.selectedTheme.layerStyles.groupName}
    />
  );
});
...
const SymbolsGroup = memo(() => {
  ...
  return (
    <ContainerGroup
      ...
      selectedGroup={state.selectedTheme.symbols.groupName}
    />
  );
});
