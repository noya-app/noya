...
export function createJSPath(PathKit: any) {
  class JSPath extends JSEmbindObject implements Path {
    ...
    makeAsWinding(): Path | null {
      throw new Error(`JSPath.makeAsWinding not implemented!`);
    }
    addArc(
      oval: InputRect,
      ...
      throw new Error(`JSPath.addArc not implemented!`);
    }
    ...
    addPath(...args: any[]): Path | null {
      throw new Error(`JSPath.addPath not implemented!`);
    }
    addPoly(points: InputFlattenedPointArray, close: boolean): Path {
      throw new Error(`JSPath.addPoly not implemented!`);
    }
    addRect(rect: InputRect, isCCW?: boolean): Path {
      throw new Error(`JSPath.addRect not implemented!`);
    }
    addRRect(rrect: InputRRect, isCCW?: boolean): Path {
      throw new Error(`JSPath.addRRect not implemented!`);
    }
    addVerbsPointsWeights(
      ...
      throw new Error(`JSPath.addVerbsPointsWeights not implemented!`);
    }
    arc(
      x: number,
      y: number,
      ...
      throw new Error(`JSPath.arc not implemented!`);
    }
    arcToOval(
      oval: InputRect,
      startAngle: AngleInDegrees,
      ...
      throw new Error(`JSPath.arcToOval not implemented!`);
    }
    arcToRotated(
      rx: number,
      ry: number,
      ...
      throw new Error(`JSPath.arcToRotated not implemented!`);
    }
    arcToTangent(
      x1: number,
      y1: number,
    ...
    countPoints(): number {
      throw new Error(`JSPath.countPoints not implemented!`);
    }
    cubicTo(
      cpx1: number,
      cpy1: number,
    ...
    dash(on: number, off: number, phase: number): boolean {
      throw new Error(`JSPath.dash not implemented!`);
    }
    equals(other: Path): boolean {
      throw new Error(`JSPath.equals not implemented!`);
    }
    getBounds(outputArray?: Rect): Rect {
      throw new Error(`JSPath.getBounds not implemented!`);
    }
    ...
    getPoint(index: number, outputArray?: Point): Point {
      throw new Error(`JSPath.getPoint not implemented!`);
    }
    isEmpty(): boolean {
      throw new Error(`JSPath.isEmpty not implemented!`);
    }
    isVolatile(): boolean {
      throw new Error(`JSPath.isVolatile not implemented!`);
    }
    ...
    offset(dx: number, dy: number): Path {
      throw new Error(`JSPath.offset not implemented!`);
    }
    ...
    rArcTo(
      ...
      throw new Error(`JSPath.rArcTo not implemented!`);
    }
    rConicTo(
      dx1: number,
      dy1: number,
      ...
      throw new Error(`JSPath.rConicTo not implemented!`);
    }
    rCubicTo(
      cpx1: number,
      cpy1: number,
      ...
      throw new Error(`JSPath.rCubicTo not implemented!`);
    }
    reset(): void {
      throw new Error(`JSPath.reset not implemented!`);
    }
    rewind(): void {
      throw new Error(`JSPath.rewind not implemented!`);
    }
    rLineTo(x: number, y: number): Path {
      throw new Error(`JSPath.rLineTo not implemented!`);
    }
    rMoveTo(x: number, y: number): Path {
      throw new Error(`JSPath.rMoveTo not implemented!`);
    }
    rQuadTo(x1: number, y1: number, x2: number, y2: number): Path {
      throw new Error(`JSPath.rQuadTo not implemented!`);
    }
    ...
    setIsVolatile(volatile: boolean): void {
      throw new Error(`JSPath.setIsVolatile not implemented!`);
    }
    simplify(): boolean {
      throw new Error(`JSPath.simplify not implemented!`);
    }
    ...
    transform(...args: any[]): Path {
      throw new Error(`JSPath.transform not implemented!`);
    }
    trim(startT: number, stopT: number, isComplement: boolean): Path | null {
      throw new Error(`JSPath.trim not implemented!`);
    }
