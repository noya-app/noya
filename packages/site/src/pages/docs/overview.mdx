...
With Noya, you design your project with **blocks**. A **block** is a
wireframe-like representation of a UI component such as "Hero" or "Button". The
Noya tool automatically generates a high-fidelity output in real time by mapping
low-fidelity blocks into high-fidelity design system and React components.
