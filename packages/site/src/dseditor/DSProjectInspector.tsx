...
export function DSProjectInspector({
  ...
  return (
    <InspectorContainer width="300px">
        ...
        <ListView.Root
          ...
          acceptsDrop={(sourceIndex, destinationIndex, position) => {
            ...
            if (
              ...
              if (destinationItem.type === 'group' && position === 'inside') {
                return true;
              } else if (
          ...
          onMoveItem={(
            ...
            if (sourceItem.type !== 'item' || destinationItem.type !== 'item') {
              return;
            }
            ...
            onMoveComponent(
              sourceItem.value.componentID,
              ListView.normalizeIndex(destinationIndexInComponents, position),
          ...
          {system.dependencies && (
            <Stack.V>
              ...
              <Stack.V background={theme.colors.codeBackground}>
                <ListView.Root>
                  {Object.entries(system.dependencies).map(([key, value]) => (
